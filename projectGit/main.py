...
# Additional function to: Количество Учащихся, Проголосовавших За Указанные Периоды
...
# ===== Lena's part: Количество Учащихся, Проголосовавших За Указанные Периоды
...
# ===== Ira's part: Ежегодная Средняя Оценка По Каждому Показателю
...
# ===== Lena's part: Разделение преподавателей на группы по средней оценке
